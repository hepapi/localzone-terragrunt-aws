terraform {
  source = "tfr:///terraform-aws-modules/iam/aws//modules/iam-role-for-service-accounts-eks//?version=${local.env_vars.locals.module_versions.iam_attach_ebs_role}"
}
...
inputs = {
  role_name             = local.env_vars.locals.eks.create_iam_ebs
